...
pub impl AchievementImpl of AchievementTrait {
    ...
    fn identifier(self: Achievement) -> felt252 {
        match self {
            Achievement::None => 0,
            Achievement::MiniGamer => 'MiniGamer', // Play a game once
            Achievement::MasterGamer => 'MasterGamer', // Play a game 10 times
            Achievement::LegendGamer => 'LegendGamer', // Play a game 20 times
            Achievement::AllStarGamer => 'AllStarGamer', // Play a game 30 times
            Achievement::SenseiGamer => 'SenseiGamer', // Play a game 50 times
        }        
    }
